...
for method in optimization_methods:
    ...
    network = Network({
        0: Reshaper(1, 28, 28),
        1: DenceLayer(28 * 28, 32, 'dropout', method),
        2: DenceLayer(32, 32, 'dropout', method),
        3: DenceLayer(32, 10, 'softmax', method),
    })
...
np.savetxt('mid-dence[1].w-784x32-row.csv', network.ns[1].w.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[1].w-784x32-bin.csv', np.where(network.ns[1].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('mid-dence[1].b-32-row.csv', network.ns[1].b.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[1].b-32-bin.csv', np.where(network.ns[1].b.T > 0, True, False), delimiter=',', fmt='%d')

np.savetxt('mid-dence[2].w-32x32-row.csv', network.ns[2].w.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[2].w-32x32-bin.csv', np.where(network.ns[2].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('mid-dence[2].b-32-row.csv', network.ns[2].b.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[2].b-32-bin.csv', np.where(network.ns[2].b.T > 0, True, False), delimiter=',', fmt='%d')

np.savetxt('mid-dence[3].w-32x10-row.csv', network.ns[3].w.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[3].w-32x10-bin.csv', np.where(network.ns[3].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('mid-dence[3].b-10-row.csv', network.ns[3].b.T, delimiter=',', fmt='%.8f')
np.savetxt('mid-dence[3].b-10-bin.csv', np.where(network.ns[3].b.T > 0, True, False), delimiter=',', fmt='%d')
