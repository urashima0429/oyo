...
for method in optimization_methods:
    ...
    network = Network({
        0: Reshaper(1, 28, 28),
        1: DenceLayer(28 * 28, 16, 'dropout', method),
        2: DenceLayer(16, 16, 'dropout', method),
        3: DenceLayer(16, 10, 'softmax', method),
    })
...
np.savetxt('min-dence[1].w-784x16-row.csv', network.ns[1].w.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[1].w-784x16-bin.csv', np.where(network.ns[1].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('min-dence[1].b-16-row.csv', network.ns[1].b.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[1].b-16-bin.csv', np.where(network.ns[1].b.T > 0, True, False), delimiter=',', fmt='%d')

np.savetxt('min-dence[2].w-16x16-row.csv', network.ns[2].w.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[2].w-16x16-bin.csv', np.where(network.ns[2].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('min-dence[2].b-16-row.csv', network.ns[2].b.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[2].b-16-bin.csv', np.where(network.ns[2].b.T > 0, True, False), delimiter=',', fmt='%d')

np.savetxt('min-dence[3].w-16x10-row.csv', network.ns[3].w.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[3].w-16x10-bin.csv', np.where(network.ns[3].w.T > 0, True, False), delimiter=',', fmt='%d')
np.savetxt('min-dence[3].b-10-row.csv', network.ns[3].b.T, delimiter=',', fmt='%.8f')
np.savetxt('min-dence[3].b-10-bin.csv', np.where(network.ns[3].b.T > 0, True, False), delimiter=',', fmt='%d')
